        ...
        >
          <div class="space-y-8 sm:space-y-4">
                ...
                <table class="w-full min-w-[600px] sm:min-w-[800px]">
                  ...
                  <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                    ...
                    >
                      ...
                      <td class="px-2 sm:px-3 lg:px-4 py-2">
                        <span
                          :class="getSourceClasses(booking.source)"
                      ...
                      <td class="px-2 sm:px-3 lg:px-4 py-2">
                        ...
                        >
                          <div
                            :class="
                              getPaymentStatusDotClasses(booking.paymentStatus)
                            "
            ...
            >
              ...
              >
                {{ selectedCount }} of {{ bookings.length }} row(s) selected.
              </div>
...
// Set page title
useHead({
  title: "Bookings - iVisa",
});

// Sample booking data - matching the image structure
const bookings = ref([
  {
    id: 1,
    bookingId: "#123312",
    property: "117 Executive Tower Business Bay Dubai",
    checkIn: "Jan 4, 2022",
    checkout: "Jan 4, 2022",
    source: "Booking.com",
  ...
  return bookings.value.filter(
    (booking) =>
      ...
      booking.property
        .toLowerCase()
        .includes(searchQuery.value.toLowerCase()) ||
      booking.source.toLowerCase().includes(searchQuery.value.toLowerCase())
  );
});

const selectedCount = computed(() => {
  return bookings.value.filter((booking) => booking.selected).length;
});
...
const getPaymentStatusDotClasses = (status) => {
  switch (status) {
    case "Partially Paid":
      return "bg-blue-400";
    case "Paid":
